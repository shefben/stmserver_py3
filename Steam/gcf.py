import struct, io, sys, os, logging
...
class GCF :
    def __init__(self, filename) :
        ...
        block_data = io.StringIO(self.f.read(self.blockcount * 28))
        self.block_entries = {}
        ...
        frag_data = io.StringIO(self.f.read(blockcount * 4))
        self.frag_entries = {}
        ...
        dirmap_data = io.StringIO(self.f.read(self.manifest.num_items * 4))
        self.dirmap_entries = {}
